...
function MapPosePage({ mapName, onBack }) {
  ...
  useEffect(() => {
    fetch(`http://68e9-65-0-134-209.ngrok-free.app/navigation/list/pose/${encodeURIComponent(mapName)}`)
  ...
  useEffect(() => {
    const fetchRobotLocation = async () => {
        try {
            const response = await fetch('http://68e9-65-0-134-209.ngrok-free.app/navigation/goal/feedback');
            if (!response.ok) {
  ...
  const handleAddPose = () => {
    fetch('http://68e9-65-0-134-209.ngrok-free.app/navigation/new/pose', {
      method: 'POST',
      headers: {
  ...
  const handleNavigationGoalStart = async () => {
    const response_navigation = await fetch('http://68e9-65-0-134-209.ngrok-free.app/navigation/goal/start', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const handleNavigationGoalStop = async () => {
    const response_cancel = await fetch('http://68e9-65-0-134-209.ngrok-free.app/navigation/goal/cancel', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const handleGoalPoseDetails = async (pose) => {
    const response = await fetch('http://68e9-65-0-134-209.ngrok-free.app/navigation/pose', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const handleSetInitialPose = () => {
    fetch('http://68e9-65-0-134-209.ngrok-free.app/navigation/initial_pose', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
